...
public abstract class ContextInitializer {
  ...
  private static String srcDirectory = "../../../data/translated_projects/commons-fileupload/src/";
  private static String packageDirectory = "../../../data/translated_projects/commons-fileupload/";
  ...
  public static Value[] getPythonClasses(String filePath, String... classNames) {
    try {
