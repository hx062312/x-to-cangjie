...
PROJECT_NAME="$1"
PROJECT_DIR="./projects/java/automated_reduced_projects/$PROJECT_NAME"
...
if ! mvn clean install -DskipTests -Drat.skip -Dgpg.skip -Dcheckstyle.skip -Dmaven.compiler.source=1.8 -Dmaven.compiler.target=1.8; then
