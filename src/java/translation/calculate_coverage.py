        ...
        for method in methods:
            ...
            if any(line in covered_lines for line in method_lines):
                ...
                for class_ in classes:
                    if (
                        class_.lineno <= method.lineno
                        and class_.end_lineno >= method.end_lineno
                    ):
                ...
                for method_ in covered_method_schema_data["classes"][class_name][
                    "methods"
                ]:
                    if method_name.endswith("_"):
                        potential_keyword_name = method_name[:-1]
                        if (
                            potential_keyword_name in reserved_tokens
                            and potential_keyword_name == method_.split(":")[1]
                        ):
                            method_name = method_
                            break
                        ...
                        "protected"
                        in covered_method_schema_data["classes"][class_name]["methods"][
                            method_
                        ]["modifiers"]
                    ):
                        ...
                        and method_name[4:] == method_.split(":")[1]
                    ):
                        method_name = method_
                        break
                    else:
                ...
                if ":" not in method_name:
                    print(
                        f"{method_name} not found in schema {py_file_path}::{class_name}"
                    )
                    continue
